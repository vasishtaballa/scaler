...
public class BinaryTree {
	...
	int largestBSTUtil(Node node, Value min_ref, Value max_ref, Value max_size_ref, Value is_bst_ref) {
		 ...
		 * Following tasks are done by recursive call for left subtree a) Get the
		 * maximum value in left subtree (Stored in *max_ref) b) Check whether Left
		 * Subtree is BST or not (Stored in *is_bst_ref) c) Get the size of maximum size
		 * BST in left subtree (updates *max_size)
		 ...
		 * The following recursive call does similar (similar to left subtree) task for
		 * right subtree
		 ...
		 * properties hold for this node, then this tree is BST. So return the size of
		 * this tree
	...
	public static void main(String[] args) {
		 ...
		 * Let us construct the following Tree 50 / \ 10 60 / \ / \ 5 20 55 70 / / \ 45
		 * 65 80
		 ...
		 * The complete tree is not BST as 45 is in right subtree of 50. The following
		 * subtree is the largest BST 60 / \ 55 70 / / \ 45 65 80
